...
const PRESCRIPTION_IMAGE_MAP: { [key: number]: string } = {
  1: "/home/jwlee/volume/Qwen2-vl-finetune-wo/scripts/test-Img/images/00001.jpg",
  2: "/home/jwlee/volume/Qwen2-vl-finetune-wo/scripts/test-Img/images/00003.jpg",
  // ... 다른 처방전 ID 및 경로
};
